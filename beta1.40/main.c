/**
  ************************************************************************************
  * @file    	main.c
  * @authors 	Yue Wang 12027710,		Yuanzheng Zhao	11040736
  * @version 	V2.0.0
  * @date    	17-April-2014
  * @brief   	For the Project 1, 281.384 Embedded System Design.
   ***********************************************************************************
  */
//------------------------------------------------------------------------------------
// Includes
...
void main(void)
{
	...
	{	
		...
		transmit("\r\n\t\t\t\t1 : TEST LCD\r\n\t\t\t\t2 : TEST LED\r\n\t\t\t\t3 : TEST ADC\r\n\t\t\t\t4 : TEST DIP\r\n\t\t\t\t5 : TEST BTN\r\n\t\t\t\t6 : TEST DAC\r\n\t\t\t\t7 : TEST PWM\r\n");
		transmit("\t\t\t\t\t\t by @alan @derrick, 17 apr 2014.\r\n");
...
void handle_command(unsigned char* data cmd)
{
	switch(*cmd)
	{
		...
		case '4'	:
			lcd_goto(0x00);
			printf("   Tesing DIP");	
			transmit("case 4	DIP : adjust dip , check LCD . any key to quit.\r\n");
		...
		case '7'	:
			lcd_goto(0x00);
			printf("   Testing PWM");	
			transmit("case 7	PWM :  check scope, adjust dutycylce using DIP. any key to quit \r\n");
